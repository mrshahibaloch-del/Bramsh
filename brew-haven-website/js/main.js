...
(() => {
  ...
  const bindForm = (formId, messageId, successText) => {
  ...
  bindForm('reservation-form', 'reservation-message', 'You’re all set — we’ll confirm your table shortly.');
  bindForm('newsletter-form', 'newsletter-message', 'Welcome in. Your first note is on its way.');
})();
